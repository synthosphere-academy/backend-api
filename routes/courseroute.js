...
const {getenrolledcourseby_userid,getenrolledcourseby_teacherid,get_course,course,getcourse_by_id,searchcourse,update_course,delete_course }  = require('../controller/Coursecontroller')
const {blog_post,get_blog,getblogby_id,update_blog,delete_blog} = require('../controller/blogcontroller')
