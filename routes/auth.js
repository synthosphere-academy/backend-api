...
const { register, login ,get_user,get_register,offlineregister,paymentverification,get_offline,get_payment ,getuser_by_id} = require('../controller/authController');
